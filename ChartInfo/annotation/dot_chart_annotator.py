...
from ChartInfo.data.dot_values import DotValues
from ChartInfo.data.dot_data import DotData

class DotChartAnnotator(BaseImageAnnotator):
    ModeNavigate = 0
    ModeNumberEdit = 1
    ModeSeriesSelect = 2
    ModeSeriesEdit = 3
    ...
    def __init__(self, size, panel_image, panel_info, parent_screen):
        BaseImageAnnotator.__init__(self, "Dot Chart Ground Truth Annotation Interface", size)
        ...
        if self.panel_info.data is None:
            ...
            self.data = DotData.CreateDefault(self.panel_info)
            self.data_changed = True
        else:
            # make a copy ...
            self.data = DotData.Copy(self.panel_info.data)
        ...
        self.mark_size = 50
        self.crosshairs_type = DotChartAnnotator.CrossHairs_0_90_180_270
        ...
        self.tempo_dot_index = None
        self.tempo_point_index = None
        self.tempo_dot_values = None
        ...
        self.container_dot_buttons = None
        self.lbl_dot_title = None
        self.lbl_dot_cross_hairs = None
        self.img_dot_cross_hairs_0_90_180_270 = None
        self.img_dot_cross_hairs_45_135_225_315 = None
        self.img_dot_cross_hairs_30_150_270 = None
        self.img_dot_cross_hairs_90_210_330 = None
        self.lbl_dot_name = None
        self.lbx_dot_points = None
        self.btn_dot_point_edit = None
        self.btn_dot_point_delete = None
        self.btn_dot_point_add = None
        self.btn_dot_return_accept = None
        self.btn_dot_return_cancel = None
    ...
    def create_controllers(self):
        ...
        # Main Title
        self.label_title = ScreenLabel("title", "Chart Image Annotation Tool - Dot Chart Data Annotation", 28)
        ...
        self.lbl_edit_title = ScreenLabel("lbl_edit_title", "Dot Chart Annotation Options", 21, 290, 1)
        ...
        self.btn_edit_data = ScreenButton("btn_edit_data", "Edit Dot Data", 21, button_width)
        ...
        self.container_dot_buttons = ScreenContainer("container_dot_buttons", (container_width, 550),
                                                         back_color=darker_background)
        self.container_dot_buttons.position = (self.container_view_buttons.get_left(),
                                                   self.container_view_buttons.get_bottom() + 20)
        self.elements.append(self.container_dot_buttons)

        self.lbl_dot_title = ScreenLabel("lbl_dot_title", "Points in Dot", 25, 290, 1)
        self.lbl_dot_title.position = (5, 5)
        self.lbl_dot_title.set_background(darker_background)
        self.lbl_dot_title.set_color(self.text_color)
        self.container_dot_buttons.append(self.lbl_dot_title)

        self.lbl_dot_cross_hairs = ScreenLabel("lbl_dot_cross_hairs", "Available Crosshairs", 18, 290, 1)
        self.lbl_dot_cross_hairs.position = (5, self.lbl_dot_title.get_bottom() + 20)
        self.lbl_dot_cross_hairs.set_background(darker_background)
        self.lbl_dot_cross_hairs.set_color(self.text_color)
        self.container_dot_buttons.append(self.lbl_dot_cross_hairs)
        ...
        angles = self.get_crosshair_angles(DotChartAnnotator.CrossHairs_0_90_180_270)
        cross_hair_img = self.create_cross_hairs_image(cross_hair_size, angles, (255, 0, 0), (255, 255, 255))
        self.img_dot_cross_hairs_0_90_180_270 = ScreenImage("img_dot_cross_hairs_0_90_180_270", cross_hair_img,
                                                                0, 0, True, cv2.INTER_NEAREST)
        self.img_dot_cross_hairs_0_90_180_270.position = (int(container_width * (3 / 18) - cross_hair_size / 2),
                                                              self.lbl_dot_cross_hairs.get_bottom() + 10)
        self.img_dot_cross_hairs_0_90_180_270.mouse_button_down_callback = self.img_dot_cross_hairs_mouse_button_down
        self.container_dot_buttons.append(self.img_dot_cross_hairs_0_90_180_270)

        angles = self.get_crosshair_angles(DotChartAnnotator.CrossHairs_45_135_225_315)
        cross_hair_img = self.create_cross_hairs_image(cross_hair_size, angles, (255, 0, 0), (255, 255, 255))
        self.img_dot_cross_hairs_45_135_225_315 = ScreenImage("img_dot_cross_hairs_45_135_225_315",
                                                                  cross_hair_img, 0, 0, True, cv2.INTER_NEAREST)
        self.img_dot_cross_hairs_45_135_225_315.position = (int(container_width * (7 / 18) - cross_hair_size / 2),
                                                                self.lbl_dot_cross_hairs.get_bottom() + 10)
        self.img_dot_cross_hairs_45_135_225_315.mouse_button_down_callback = self.img_dot_cross_hairs_mouse_button_down
        self.container_dot_buttons.append(self.img_dot_cross_hairs_45_135_225_315)

        angles = self.get_crosshair_angles(DotChartAnnotator.CrossHairs_30_150_270)
        cross_hair_img = self.create_cross_hairs_image(cross_hair_size, angles, (255, 0, 0), (255, 255, 255))
        self.img_dot_cross_hairs_30_150_270 = ScreenImage("img_dot_cross_hairs_30_150_270", cross_hair_img,
                                                              0, 0, True, cv2.INTER_NEAREST)
        self.img_dot_cross_hairs_30_150_270.position = (int(container_width * (11 / 18) - cross_hair_size / 2),
                                                            self.lbl_dot_cross_hairs.get_bottom() + 10)
        self.img_dot_cross_hairs_30_150_270.mouse_button_down_callback = self.img_dot_cross_hairs_mouse_button_down
        self.container_dot_buttons.append(self.img_dot_cross_hairs_30_150_270)

        angles = self.get_crosshair_angles(DotChartAnnotator.CrossHairs_90_210_330)
        cross_hair_img = self.create_cross_hairs_image(cross_hair_size, angles, (255, 0, 0), (255, 255, 255))
        self.img_dot_cross_hairs_90_210_330 = ScreenImage("img_dot_cross_hairs_90_210_330", cross_hair_img,
                                                              0, 0, True, cv2.INTER_NEAREST)
        self.img_dot_cross_hairs_90_210_330.position = (int(container_width * (15 / 18) - cross_hair_size / 2),
                                                            self.lbl_dot_cross_hairs.get_bottom() + 10)
        self.img_dot_cross_hairs_90_210_330.mouse_button_down_callback = self.img_dot_cross_hairs_mouse_button_down
        self.container_dot_buttons.append(self.img_dot_cross_hairs_90_210_330)

        self.lbl_dot_name = ScreenLabel("lbl_dot_name", "[Data series]", 18, 290, 1)
        self.lbl_dot_name.position = (5, self.img_dot_cross_hairs_0_90_180_270.get_bottom() + 20)
        self.lbl_dot_name.set_background(darker_background)
        self.lbl_dot_name.set_color(self.text_color)
        self.container_dot_buttons.append(self.lbl_dot_name)

        self.lbx_dot_points = ScreenTextlist("lbx_dot_points", (container_width - 20, 210), 18,
                                                 back_color=(255, 255, 255), option_color=(0, 0, 0),
                                                 selected_back=(120, 80, 50), selected_color=(255, 255, 255))
        self.lbx_dot_points.position = (10, self.lbl_dot_name.get_bottom() + 30)
        self.lbx_dot_points.selected_value_change_callback = self.lbx_dot_points_value_changed
        self.container_dot_buttons.append(self.lbx_dot_points)

        self.btn_dot_point_add = ScreenButton("btn_dot_point_add", "Add Points", 21, button_2_width)
        self.btn_dot_point_add.set_colors(button_text_color, button_back_color)
        self.btn_dot_point_add.position = (button_2_left, self.lbx_dot_points.get_bottom() + 10)
        self.btn_dot_point_add.click_callback = self.btn_dot_point_add_click
        self.container_dot_buttons.append(self.btn_dot_point_add)

        self.btn_dot_point_edit = ScreenButton("btn_dot_point_edit", "Edit Points", 21, button_2_width)
        self.btn_dot_point_edit.set_colors(button_text_color, button_back_color)
        self.btn_dot_point_edit.position = (button_2_right, self.lbx_dot_points.get_bottom() + 10)
        self.btn_dot_point_edit.click_callback = self.btn_dot_point_edit_click
        self.container_dot_buttons.append(self.btn_dot_point_edit)

        self.btn_dot_point_delete = ScreenButton("btn_dot_point_delete", "Remove Point", 21, button_width)
        self.btn_dot_point_delete.set_colors(button_text_color, button_back_color)
        self.btn_dot_point_delete.position = (button_left, self.btn_dot_point_add.get_bottom() + 10)
        self.btn_dot_point_delete.click_callback = self.btn_dot_point_delete_click
        self.container_dot_buttons.append(self.btn_dot_point_delete)

        self.btn_dot_return_accept = ScreenButton("btn_dot_return_accept", "Accept", 21, button_2_width)
        self.btn_dot_return_accept.set_colors(button_text_color, button_back_color)
        self.btn_dot_return_accept.position = (button_2_left, self.btn_dot_point_delete.get_bottom() + 20)
        self.btn_dot_return_accept.click_callback = self.btn_dot_return_accept_click
        self.container_dot_buttons.append(self.btn_dot_return_accept)

        self.btn_dot_return_cancel = ScreenButton("btn_dot_return_cancel", "Cancel", 21, button_2_width)
        self.btn_dot_return_cancel.set_colors(button_text_color, button_back_color)
        self.btn_dot_return_cancel.position = (button_2_right, self.btn_dot_point_delete.get_bottom() + 20)
        self.btn_dot_return_cancel.click_callback = self.btn_dot_return_cancel_click
        self.container_dot_buttons.append(self.btn_dot_return_cancel)

        self.container_dot_buttons.visible = False
        ...
        self.set_editor_mode(DotChartAnnotator.ModeNavigate)
    ...
    def get_crosshair_angles(self, crosshair_type):
        if crosshair_type == DotChartAnnotator.CrossHairs_0_90_180_270:
            return [0, np.pi / 2.0, np.pi, np.pi * 3 / 2.0]
        elif crosshair_type == DotChartAnnotator.CrossHairs_45_135_225_315:
            return [np.pi / 4.0, np.pi * 3.0 / 4.0, np.pi * 5.0 / 4.0, np.pi * 7.0 / 4.0]
        elif crosshair_type == DotChartAnnotator.CrossHairs_30_150_270:
            return [np.pi * 1.0 / 6.0, np.pi * 5.0 / 6.0, np.pi * 3.0 / 2.0]
        elif crosshair_type == DotChartAnnotator.CrossHairs_90_210_330:
    ...
    def btn_confirm_cancel_click(self, button):
        if self.edition_mode in [DotChartAnnotator.ModeConfirmExit]:
            # return to navigation
            self.set_editor_mode(DotChartAnnotator.ModeNavigate)
        elif self.edition_mode in [DotChartAnnotator.ModePointAdd]:
            # return to series edition mode ...
            self.update_points_list()
            self.set_editor_mode(DotChartAnnotator.ModeSeriesEdit)
        elif self.edition_mode in [DotChartAnnotator.ModePointEdit]:
            # copy data from Canvas to the structure ....
            canvas_points = self.canvas_display.elements[self.tempo_canvas_name].points
            # print(self.tempo_dot_values.points)
            for point_idx, (px, py) in enumerate(canvas_points):
                ...
                self.tempo_dot_values.set_point(point_idx, rel_x, rel_y)
            # print(self.tempo_dot_values.points)
            # lock the canvas ...
    ...
    def btn_confirm_accept_click(self, button):
        if self.edition_mode == DotChartAnnotator.ModeConfirmExit:
            print("-> Changes made to Dot Data Annotations were lost")
            self.return_screen = self.parent_screen
        else:
            raise Exception("Not Implemented")

    def btn_edit_number_click(self, button):
        self.set_editor_mode(DotChartAnnotator.ModeNumberEdit)
        self.update_current_view()

    def btn_edit_data_click(self, button):
        self.fill_data_series_list(self.lbx_data_series_values)
        self.set_editor_mode(DotChartAnnotator.ModeSeriesSelect)
        self.update_current_view()

    def btn_return_accept_click(self, button):
        if self.data_changed:
            # overwrite existing Line data ...
            self.panel_info.data = DotData.Copy(self.data)
    ...
    def btn_return_cancel_click(self, button):
        if self.data_changed:
            self.set_editor_mode(DotChartAnnotator.ModeConfirmExit)
        else:
            # simply return
            self.return_screen = self.parent_screen
    ...
    def img_main_mouse_button_down(self, img_object, pos, button):
        if self.edition_mode == DotChartAnnotator.ModePointAdd and button in [1, 3]:
            # Add the new point
            if button == 1:
                # click pos ...
            ...
            self.tempo_dot_values.add_point(rel_x, rel_y)
            # update canvas ....
            ps_points = self.dot_points_to_canvas_points(self.tempo_dot_values.points)
    ...
    def create_canvas_point_sets(self):
        ...
        for idx, dot_values in enumerate(self.data.dot_values):
            # line_color = self.canvas_display.colors[idx % len(self.canvas_display.colors)]
            all_transformed_points = self.dot_points_to_canvas_points(dot_values.points)
            self.canvas_display.add_point_set_element("dot_" + str(idx), all_transformed_points)

    def dot_points_to_canvas_points(self, point_set):
        x1, y1, x2, y2 = self.panel_info.axes.bounding_box
    ...
    def set_editor_mode(self, new_mode):
        ...
        # Navigation mode ...
        self.container_annotation_buttons.visible = (self.edition_mode == DotChartAnnotator.ModeNavigate)

        # edit modes ...
        self.container_number_buttons.visible = (self.edition_mode == DotChartAnnotator.ModeNumberEdit)
        self.container_data_buttons.visible = (self.edition_mode == DotChartAnnotator.ModeSeriesSelect)
        self.container_dot_buttons.visible = (self.edition_mode == DotChartAnnotator.ModeSeriesEdit)
        self.container_preview_buttons.visible = (self.edition_mode == DotChartAnnotator.ModePointAdd)

        # Confirm panel and buttons  ...
        self.container_confirm_buttons.visible = self.edition_mode in [DotChartAnnotator.ModeConfirmNumberOverwrite,
                                                                       DotChartAnnotator.ModePointAdd,
                                                                       DotChartAnnotator.ModePointEdit,
                                                                       DotChartAnnotator.ModeConfirmExit]

        if self.edition_mode == DotChartAnnotator.ModeConfirmNumberOverwrite:
            self.lbl_confirm_message.set_text("Discard Existing Series Data?")
        elif self.edition_mode == DotChartAnnotator.ModePointAdd:
            self.lbl_confirm_message.set_text("Click on New Point")
        elif self.edition_mode == DotChartAnnotator.ModePointEdit:
            self.lbl_confirm_message.set_text("Drag Points")
        elif self.edition_mode == DotChartAnnotator.ModeConfirmExit:
            self.lbl_confirm_message.set_text("Discard Changes to Dot Data?")

        # Do not show accept at these steps (they can be implicitly accepted, but need explicit cancel button only)
        self.btn_confirm_accept.visible = self.edition_mode not in [DotChartAnnotator.ModePointAdd,
                                                                    DotChartAnnotator.ModePointEdit]
    ...
    def btn_data_series_edit_click(self, button):
        ...
        # prepare temporals
        self.tempo_dot_index = option_idx
        self.tempo_dot_values = DotValues.Copy(self.data.dot_values[option_idx])

        # series name ...
        display = self.lbx_data_series_values.option_display[self.lbx_data_series_values.selected_option_value]
        self.lbl_dot_name.set_text(display)

        # ... list of points ...
        self.update_points_list()

        # canvas
        self.canvas_show_hide_dots(option_idx)
        self.canvas_display.locked = True

        self.set_editor_mode(DotChartAnnotator.ModeSeriesEdit)
        self.update_current_view(False)

    def canvas_show_hide_dots(self, show_index):
        self.canvas_display.change_selected_element(None)
        self.tempo_canvas_name = None
        for element_name in self.canvas_display.elements:
            dot_idx = int(element_name.split("_")[1])
            self.canvas_display.elements[element_name].visible = (show_index < 0 or show_index == dot_idx)
            if show_index == dot_idx:
    ...
    def update_points_list(self):
        self.lbx_dot_points.clear_options()
        for idx, (p_x, p_y) in enumerate(self.tempo_dot_values.points):
            display_value = "{0:d}: ({1:.1f}, {2:.1f})".format(idx + 1, p_x, p_y)

            self.lbx_dot_points.add_option(str(idx), display_value)

    def btn_dot_point_edit_click(self, button):
        # self.tempo_point_index = int(self.lbx_dot_points.selected_option_value)
        self.canvas_display.locked = False
        self.set_editor_mode(DotChartAnnotator.ModePointEdit)

    def delete_tempo_dot_point(self, del_idx):
        if self.tempo_dot_values.remove_point(del_idx):
            # update GUI
            # ... canvas ...
            ps_points = self.dot_points_to_canvas_points(self.tempo_dot_values.points)
            self.canvas_display.update_point_set_element(self.tempo_canvas_name, ps_points, True)
    ...
    def btn_dot_point_delete_click(self, button):
        if self.lbx_dot_points.selected_option_value is None:
            print("Must select a data point from list")
            return

        # try delete
        del_idx = int(self.lbx_dot_points.selected_option_value)
        self.delete_tempo_dot_point(del_idx)

    def btn_dot_point_add_click(self, button):
        self.set_editor_mode(DotChartAnnotator.ModePointAdd)

    def btn_dot_return_accept_click(self, button):
        self.data.dot_values[self.tempo_dot_index] = DotValues.Copy(self.tempo_dot_values)
        self.data_changed = True

        # all dots must be displayed ... and nothing should be selected
        self.canvas_show_hide_dots(-1)
        self.set_editor_mode(DotChartAnnotator.ModeSeriesSelect)
        self.update_current_view()

    def btn_dot_return_cancel_click(self, button):
        # restore the dot on the canvas to its previous  state
        ps_points = self.dot_points_to_canvas_points(self.data.dot_values[self.tempo_dot_index].points)
        self.canvas_display.update_point_set_element(self.tempo_canvas_name, ps_points, True)
        # all dots must be displayed ... and nothing should be selected on the canvas
        self.canvas_show_hide_dots(-1)

        self.set_editor_mode(DotChartAnnotator.ModeSeriesSelect)
        self.update_current_view(False)

    def lbx_dot_points_value_changed(self, new_value, old_value):
        pass
        # self.update_current_view(False)

    def img_main_mouse_double_click(self, img, position, button):
        if self.edition_mode == DotChartAnnotator.ModeSeriesEdit:
            # click relative position
            rel_x, rel_y = self.from_pos_to_rel_click(position)

            # find closest point ...
            distance, point_idx = self.tempo_dot_values.closest_point(rel_x, rel_y)

            if button == 1:
                # left click
                if point_idx is not None and distance < DotChartAnnotator.DoubleClickMaxPointDistance:
                    # ... edit...
                    self.canvas_display.locked = False
                    self.set_editor_mode(DotChartAnnotator.ModePointEdit)
                else:
                ...
                # right click ... delete ...
                if distance < DotChartAnnotator.DoubleClickMaxPointDistance:
                    self.delete_tempo_dot_point(point_idx)

        elif self.edition_mode in [DotChartAnnotator.ModeNavigate, DotChartAnnotator.ModeSeriesSelect]:
            ...
            for idx, current_text in enumerate(self.data.data_series):
                if current_text is not None:
                    ...
                    if current_text.area_contains_point(rel_x, rel_y):
                        if self.edition_mode == DotChartAnnotator.ModeNavigate:
    ...
    def img_main_mouse_motion(self, screen_img, pos, rel, buttons):
        if self.edition_mode in [DotChartAnnotator.ModeSeriesEdit, DotChartAnnotator.ModePointAdd]:
            mouse_x, mouse_y = pos
            ...
            if self.crosshairs_type in [DotChartAnnotator.CrossHairs_30_150_270,
                                        DotChartAnnotator.CrossHairs_90_210_330]:
            ...
            if self.edition_mode == DotChartAnnotator.ModePointAdd:
                valid_cc = True
    ...
    def img_dot_cross_hairs_mouse_button_down(self, img_object, pos, button):
        if img_object.name == "img_dot_cross_hairs_0_90_180_270":
            self.crosshairs_type = DotChartAnnotator.CrossHairs_0_90_180_270
        elif img_object.name == "img_dot_cross_hairs_45_135_225_315":
            self.crosshairs_type = DotChartAnnotator.CrossHairs_45_135_225_315
        elif img_object.name == "img_dot_cross_hairs_30_150_270":
            self.crosshairs_type = DotChartAnnotator.CrossHairs_30_150_270
        elif img_object.name == "img_dot_cross_hairs_90_210_330":
            self.crosshairs_type = DotChartAnnotator.CrossHairs_90_210_330
